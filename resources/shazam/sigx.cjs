var read_,
  ...
  moduleOverrides = objAssign({}, Module),
  arguments_ = [],
...
ENVIRONMENT_IS_NODE
  ? ((scriptDirectory = ENVIRONMENT_IS_WORKER
    ...
    (read_ = function (e, n) {
      return (requireNodeFS(), (e = nodePath.normalize(e)), fs.readFileSync(e, n ? null : "utf8"));
    }),
    ...
    (quit_ = (e, n) => {
      if (keepRuntimeAlive()) throw ((process.exitCode = e), n);
      (logExceptionOnExit(n), process.exit(e));
    }),
...
function ccall(e, n, r, t, i) {
  ...
  var _ = i && i.async;
  return Asyncify.currData ? Asyncify.whenDone().then(f) : ((d = f(d)), _ ? Promise.resolve(d) : d);
}
function cwrap(e, n, r, t) {
  ...
  return "string" !== n && i && !t
    ? getCFunc(e)
    : function () {
        return ccall(e, n, r, arguments, t);
      };
}
var UTF8Decoder = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : void 0;
function UTF8ArrayToString(e, n, r) {
  for (var t = n + r, i = n; e[i] && !(i >= t);) ++i;
  if (i - n > 16 && e.subarray && UTF8Decoder) return UTF8Decoder.decode(e.subarray(n, i));
  for (var a = ""; n < i;) {
    var o = e[n++];
    if (128 & o) {
      var u = 63 & e[n++];
...
function stringToUTF8Array(e, n, r, t) {
  if (!(t > 0)) return 0;
  for (var i = r, a = r + t - 1, o = 0; o < e.length; ++o) {
...
function lengthBytesUTF8(e) {
  for (var n = 0, r = 0; r < e.length; ++r) {
    ...
    (t >= 55296 && t <= 57343 && (t = (65536 + ((1023 & t) << 10)) | (1023 & e.charCodeAt(++r))),
...
function UTF16ToString(e, n) {
  for (var r = e, t = r >> 1, i = t + n / 2; !(t >= i) && HEAPU16[t];) ++t;
  if ((r = t << 1) - e > 32 && UTF16Decoder) return UTF16Decoder.decode(HEAPU8.subarray(e, r));
  for (var a = "", o = 0; !(o >= n / 2); ++o) {
    var u = HEAP16[(e + 2 * o) >> 1];
    if (0 == u) break;
    a += String.fromCharCode(u);
  }
  return a;
}
function stringToUTF16(e, n, r) {
  if ((void 0 === r && (r = 2147483647), r < 2)) return 0;
  for (var t = n, i = (r -= 2) < 2 * e.length ? r / 2 : e.length, a = 0; a < i; ++a) {
    var o = e.charCodeAt(a);
    ((HEAP16[n >> 1] = o), (n += 2));
  }
  return ((HEAP16[n >> 1] = 0), n - t);
}
function lengthBytesUTF16(e) {
  return 2 * e.length;
}
function UTF32ToString(e, n) {
  for (var r = 0, t = ""; !(r >= n / 4);) {
    var i = HEAP32[(e + 4 * r) >> 2];
    if (0 == i) break;
    if ((++r, i >= 65536)) {
      var a = i - 65536;
...
function stringToUTF32(e, n, r) {
  if ((void 0 === r && (r = 2147483647), r < 4)) return 0;
  for (var t = n, i = t + r - 4, a = 0; a < e.length; ++a) {
    var o = e.charCodeAt(a);
    if (o >= 55296 && o <= 57343) o = (65536 + ((1023 & o) << 10)) | (1023 & e.charCodeAt(++a));
    if (((HEAP32[n >> 2] = o), (n += 4) + 4 > i)) break;
  }
  return ((HEAP32[n >> 2] = 0), n - t);
}
function lengthBytesUTF32(e) {
  for (var n = 0, r = 0; r < e.length; ++r) {
    var t = e.charCodeAt(r);
    (t >= 55296 && t <= 57343 && ++r, (n += 4));
  }
  return n;
}
...
var wasmTable,
  INITIAL_MEMORY = Module.INITIAL_MEMORY || 16777216,
  __ATPRERUN__ = [],
  __ATINIT__ = [],
  __ATPOSTRUN__ = [],
...
function createWasm() {
  ...
  function n(e, n) {
    var r = e.exports;
    ((r = Asyncify.instrumentWasmExports(r)),
      (Module.asm = r),
      updateGlobalBufferAndViews((wasmMemory = Module.asm.I).buffer),
  ...
  if ((addRunDependency("wasm-instantiate"), Module.instantiateWasm))
    try {
      var i = Module.instantiateWasm(e, n);
      return (i = Asyncify.instrumentWasmExports(i));
    } catch (e) {
  ...
  return (
    ...
    "function" != typeof fetch
      ? t(r)
      : fetch(wasmBinaryFile, { credentials: "same-origin" }).then(function (n) {
...
isDataURI((wasmBinaryFile = "sigx.wasm")) || (wasmBinaryFile = locateFile(wasmBinaryFile));
var exceptionLast = 0,
  uncaughtExceptionCount = 0;
function ___cxa_throw(e, n, r) {
  throw (new ExceptionInfo(e).init(n, r), (exceptionLast = e), uncaughtExceptionCount++, e);
}
function __embind_register_bigint(e, n, r, t, i) {}
...
function readLatin1String(e) {
  for (var n = "", r = e; HEAPU8[r];) n += embind_charCodes[HEAPU8[r++]];
  return n;
}
...
function makeLegalFunctionName(e) {
  ...
  return n >= char_0 && n <= char_9 ? "_" + e : e;
}
function createNamedFunction(e, n) {
  return (
    (e = makeLegalFunctionName(e)),
    function () {
      return n.apply(this, arguments);
    }
  );
}
function extendError(e, n) {
  var r = createNamedFunction(n, function (e) {
...
function registerType(e, n, r) {
  if (((r = r || {}), !("argPackAdvance" in n)))
    throw new TypeError("registerType registeredInstance requires argPackAdvance");
  var t = n.name;
  if (
    (e || throwBindingError('type "' + t + '" must have a positive integer typeid pointer'),
    registeredTypes.hasOwnProperty(e))
  ) {
    if (r.ignoreDuplicateRegistrations) return;
    throwBindingError("Cannot register type '" + t + "' twice");
  }
  if (
    ((registeredTypes[e] = n), delete typeDependencies[e], awaitingDependencies.hasOwnProperty(e))
  ) {
...
function __embind_register_bool(e, n, r, t, i) {
  var a = getShiftFromSize(r);
  registerType(e, {
    name: (n = readLatin1String(n)),
...
function __emval_decref(e) {
  e > 4 &&
    0 === --emval_handle_array[e].refcount &&
    ((emval_handle_array[e] = void 0), emval_free_list.push(e));
}
function count_emval_handles() {
  for (var e = 0, n = 5; n < emval_handle_array.length; ++n)
    void 0 !== emval_handle_array[n] && ++e;
  return e;
}
  ...
  toHandle: function (e) {
    switch (e) {
      ...
      case !1:
        return 4;
      default:
        var n = emval_free_list.length ? emval_free_list.pop() : emval_handle_array.length;
        return ((emval_handle_array[n] = { refcount: 1, value: e }), n);
    }
  },
};
...
function __embind_register_emval(e, n) {
  registerType(e, {
    name: (n = readLatin1String(n)),
    fromWireType: function (e) {
      var n = Emval.toValue(e);
      return (__emval_decref(e), n);
    },
    toWireType: function (e, n) {
      return Emval.toHandle(n);
    },
    argPackAdvance: 8,
...
function floatReadValueFromPointer(e, n) {
  switch (n) {
    case 2:
      return function (e) {
...
function __embind_register_float(e, n, r) {
  var t = getShiftFromSize(r);
  registerType(e, {
    name: (n = readLatin1String(n)),
    fromWireType: function (e) {
      return e;
    ...
    argPackAdvance: 8,
    readValueFromPointer: floatReadValueFromPointer(n, t),
    destructorFunction: null,
  });
}
function integerReadValueFromPointer(e, n, r) {
  switch (n) {
    case 0:
      return r
        ? function (e) {
...
function __embind_register_integer(e, n, r, t, i) {
  ((n = readLatin1String(n)), -1 === i && (i = 4294967295));
  var a = getShiftFromSize(r),
    o = function (e) {
      return e;
    };
  ...
  registerType(e, {
    ...
    argPackAdvance: 8,
    readValueFromPointer: integerReadValueFromPointer(n, a, 0 !== t),
    destructorFunction: null,
  });
}
function __embind_register_memory_view(e, n, r) {
  var t = [
    Int8Array,
    Uint8Array,
    Int16Array,
...
function __embind_register_std_string(e, n) {
  var r = "std::string" === (n = readLatin1String(n));
  registerType(e, {
    name: n,
    fromWireType: function (e) {
      var n,
        t = HEAPU32[e >> 2];
      if (r)
        for (var i = e + 4, a = 0; a <= t; ++a) {
          var o = e + 4 + a;
          if (a == t || 0 == HEAPU8[o]) {
            var u = UTF8ToString(i, o - i);
            (void 0 === n ? (n = u) : ((n += String.fromCharCode(0)), (n += u)), (i = o + 1));
          }
        }
      else {
        var l = new Array(t);
        for (a = 0; a < t; ++a) l[a] = String.fromCharCode(HEAPU8[e + 4 + a]);
        n = l.join("");
      }
      return (_free(e), n);
    },
    toWireType: function (e, n) {
      ...
      var i = (
        ...
        a = _malloc(4 + i + 1);
      if (((HEAPU32[a >> 2] = i), r && t)) stringToUTF8(n, a + 4, i + 1);
      else if (t)
        for (var o = 0; o < i; ++o) {
          var u = n.charCodeAt(o);
          (u > 255 &&
            (_free(a), throwBindingError("String has UTF-16 code units that do not fit in 8 bits")),
            (HEAPU8[a + 4 + o] = u));
        }
      else for (o = 0; o < i; ++o) HEAPU8[a + 4 + o] = n[o];
...
function __embind_register_std_wstring(e, n, r) {
  var t, i, a, o, u;
  ((r = readLatin1String(r)),
    ...
    registerType(e, {
      name: r,
      fromWireType: function (e) {
        for (var r, i = HEAPU32[e >> 2], o = a(), l = e + 4, s = 0; s <= i; ++s) {
          var c = e + 4 + s * n;
          if (s == i || 0 == o[c >> u]) {
            var d = t(l, c - l);
            (void 0 === r ? (r = d) : ((r += String.fromCharCode(0)), (r += d)), (l = c + n));
          }
        }
        return (_free(e), r);
      },
      toWireType: function (e, t) {
        "string" != typeof t && throwBindingError("Cannot pass non-string to C++ string type " + r);
        var a = o(t),
          l = _malloc(4 + a + n);
        return ((HEAPU32[l >> 2] = a >> u), i(t, l + 4, a + n), null !== e && e.push(_free, l), l);
      },
      argPackAdvance: 8,
      readValueFromPointer: simpleReadValueFromPointer,
      destructorFunction: function (e) {
...
function __embind_register_void(e, n) {
  registerType(e, {
    isVoid: !0,
    name: (n = readLatin1String(n)),
    argPackAdvance: 0,
...
function getTypeName(e) {
  var n = ___getTypeName(e),
    r = readLatin1String(n);
  return (_free(n), r);
}
function requireRegisteredType(e, n) {
  var r = registeredTypes[e];
  return (void 0 === r && throwBindingError(n + " has unknown type " + getTypeName(e)), r);
}
function __emval_as(e, n, r) {
  ((e = Emval.toValue(e)), (n = requireRegisteredType(n, "emval::as")));
  var t = [],
    i = Emval.toHandle(t);
  return ((HEAP32[r >> 2] = i), n.toWireType(t, e));
}
function runAndAbortIfError(e) {
  try {
    return e();
  } catch (e) {
    abort(e);
...
var Asyncify = {
  ...
  getCallStackId: function (e) {
    var n = Asyncify.callStackNameToId[e];
    return (
      void 0 === n &&
        ((n = Asyncify.callStackId++),
        (Asyncify.callStackNameToId[e] = n),
        (Asyncify.callStackIdToName[n] = e)),
      n
    );
  },
          ...
          "function" == typeof t
            ? function () {
                ...
                try {
                  ...
                  if (!ABORT)
                    (assert(Asyncify.exportCallStack.pop() === r), Asyncify.maybeStopUnwind());
                }
              }
            : t;
      })(r);
  ...
  maybeStopUnwind: function () {
    Asyncify.currData &&
      ...
      0 === Asyncify.exportCallStack.length &&
  ...
  whenDone: function () {
    return new Promise(function (e, n) {
      Asyncify.asyncPromiseHandlers = { resolve: e, reject: n };
    });
  },
  allocateData: function () {
    var e = _malloc(12 + Asyncify.StackSize);
    return (
      Asyncify.setDataHeader(e, e + 12, Asyncify.StackSize),
      Asyncify.setDataRewindFunc(e),
      e
    );
  },
  setDataHeader: function (e, n, r) {
    ((HEAP32[e >> 2] = n), (HEAP32[(e + 4) >> 2] = n + r));
  },
  setDataRewindFunc: function (e) {
    var n = Asyncify.exportCallStack[0],
      r = Asyncify.getCallStackId(n);
    HEAP32[(e + 8) >> 2] = r;
  },
  getDataRewindFunc: function (e) {
    var n = HEAP32[(e + 8) >> 2],
      r = Asyncify.callStackIdToName[n];
    return Module.asm[r];
  },
  doRewind: function (e) {
    return Asyncify.getDataRewindFunc(e)();
  },
    ...
    if (!ABORT) {
      if (Asyncify.state === Asyncify.State.Normal) {
        var n = !1,
          r = !1;
        (e(function (e) {
          if (!ABORT && ((Asyncify.handleSleepReturnValue = e || 0), (n = !0), r)) {
            ...
            var t,
              i = !1;
            try {
              t = Asyncify.doRewind(Asyncify.currData);
            } catch (e) {
              ((t = e), (i = !0));
            }
            var a = !1;
            if (!Asyncify.currData) {
              var o = Asyncify.asyncPromiseHandlers;
              o &&
                ((Asyncify.asyncPromiseHandlers = null), (i ? o.reject : o.resolve)(t), (a = !0));
            }
            if (i && !a) throw t;
          }
        }),
        ...
        Asyncify.state === Asyncify.State.Rewinding
          ? ((Asyncify.state = Asyncify.State.Normal),
            ...
            Asyncify.sleepCallbacks.forEach(function (e) {
              callUserCallback(e);
            }))
  ...
  handleAsync: function (e) {
    return Asyncify.handleSleep(function (n) {
      e().then(n);
    });
  },
};
function __emval_await(e) {
  return Asyncify.handleAsync(function () {
    return (e = Emval.toValue(e)).then(Emval.toHandle);
  });
}
function __emval_allocateDestructors(e) {
  var n = [];
  return ((HEAP32[e >> 2] = Emval.toHandle(n)), n);
}
var emval_symbols = {};
function getStringOrSymbol(e) {
  var n = emval_symbols[e];
  return void 0 === n ? readLatin1String(e) : n;
}
var emval_methodCallers = [];
function __emval_call_method(e, n, r, t, i) {
  return (e = emval_methodCallers[e])(
    (n = Emval.toValue(n)),
    (r = getStringOrSymbol(r)),
    __emval_allocateDestructors(t),
    i,
  );
}
function __emval_call_void_method(e, n, r, t) {
  (e = emval_methodCallers[e])((n = Emval.toValue(n)), (r = getStringOrSymbol(r)), null, t);
}
function emval_get_global() {
  if ("object" == typeof globalThis) return globalThis;
  function e(e) {
    e.$$$embind_global$$$ = e;
    var n = "object" == typeof $$$embind_global$$$ && e.$$$embind_global$$$ === e;
...
function __emval_get_global(e) {
  return 0 === e
    ...
    : ((e = getStringOrSymbol(e)), Emval.toHandle(emval_get_global()[e]));
}
function __emval_addMethodCaller(e) {
  var n = emval_methodCallers.length;
  return (emval_methodCallers.push(e), n);
}
function __emval_lookupTypes(e, n) {
  for (var r = new Array(e), t = 0; t < e; ++t)
    r[t] = requireRegisteredType(HEAP32[(n >> 2) + t], "parameter " + t);
  return r;
}
var emval_registeredMethods = [];
function __emval_get_method_caller(e, n) {
  var r = __emval_lookupTypes(e, n),
    t = r[0],
    i =
      t.name +
      "_$" +
      r
        ...
        .join("_") +
      "$",
    a = emval_registeredMethods[i];
  if (void 0 !== a) return a;
  var o = new Array(e - 1);
  return (
    (a = __emval_addMethodCaller(function (n, i, a, u) {
      for (var l = 0, s = 0; s < e - 1; ++s)
        ((o[s] = r[s + 1].readValueFromPointer(u + l)), (l += r[s + 1].argPackAdvance));
      var c = n[i].apply(n, o);
      for (s = 0; s < e - 1; ++s) r[s + 1].deleteObject && r[s + 1].deleteObject(o[s]);
      if (!t.isVoid) return t.toWireType(a, c);
    })),
    (emval_registeredMethods[i] = a),
    a
  );
}
function __emval_get_property(e, n) {
  return ((e = Emval.toValue(e)), (n = Emval.toValue(n)), Emval.toHandle(e[n]));
}
...
function __emval_new_cstring(e) {
  return Emval.toHandle(getStringOrSymbol(e));
}
...
function __emval_run_destructors(e) {
  (runDestructors(Emval.toValue(e)), __emval_decref(e));
}
function __emval_set_property(e, n, r) {
  ((e = Emval.toValue(e)), (n = Emval.toValue(n)), (r = Emval.toValue(r)), (e[n] = r));
}
function __emval_take_value(e, n) {
  var r = (e = requireRegisteredType(e, "_emval_take_value")).readValueFromPointer(n);
...
function _emscripten_resize_heap(e) {
  ...
  for (var t = 1; t <= 4; t *= 2) {
    ...
    if (
      ...
      emscripten_realloc_buffer(Math.min(r, alignUp(Math.max(e, i), 65536))))
    )
      return !0;
  }
  return !1;
...
function _fd_seek(e, n, r, t, i) {}
function _fd_write(e, n, r, t) {
  for (var i = 0, a = 0; a < r; a++) {
    var o = HEAP32[n >> 2],
      u = HEAP32[(n + 4) >> 2];
    n += 8;
    for (var l = 0; l < u; l++) SYSCALLS.printChar(e, HEAPU8[o + l]);
    i += u;
  }
  return ((HEAP32[t >> 2] = i), 0);
}
const onSignatureReady = function (e, n, r) {
  var t = new Int8Array(r);
  (t.set(Module.HEAP8.subarray(n, n + r)),
    self.postMessage({ type: "sigready", index: e, signatureArray: t }));
};
function _onSignatureReadyImpl(e, n, r) {
  onSignatureReady(e, n, r);
}
...
var calledRun,
  ...
  _extract_signature = (Module._extract_signature = function () {
    return (_extract_signature = Module._extract_signature = Module.asm.K).apply(null, arguments);
  }),
  ...
  dynCall_v = (Module.dynCall_v = function () {
    return (dynCall_v = Module.dynCall_v = Module.asm.U).apply(null, arguments);
  }),
  _asyncify_start_unwind = (Module._asyncify_start_unwind = function () {
    return (_asyncify_start_unwind = Module._asyncify_start_unwind = Module.asm.V).apply(
      null,
      arguments,
    );
  }),
  _asyncify_stop_unwind = (Module._asyncify_stop_unwind = function () {
    return (_asyncify_stop_unwind = Module._asyncify_stop_unwind = Module.asm.W).apply(
      null,
      arguments,
    );
  }),
  _asyncify_start_rewind = (Module._asyncify_start_rewind = function () {
    return (_asyncify_start_rewind = Module._asyncify_start_rewind = Module.asm.X).apply(
      null,
      arguments,
    );
  }),
  _asyncify_stop_rewind = (Module._asyncify_stop_rewind = function () {
    return (_asyncify_stop_rewind = Module._asyncify_stop_rewind = Module.asm.Y).apply(
      null,
      arguments,
    );
  });
...
function run(e) {
  function n() {
    calledRun ||
      ...
      (Module.calledRun = !0),
      ABORT ||
        (initRuntime(), Module.onRuntimeInitialized && Module.onRuntimeInitialized(), postRun()));
  }
  ((e = e || arguments_),
    runDependencies > 0 ||
      (preRun(),
